export enum Actions {
    ...
    UPDATE_POINTS_WIN = "updateTournamentPointsWin",
    UPDATE_POINTS_DRAW = "updateTournamentPointsDraw",
    UPDATE_ALLOW_DRAWS = "updateTournamentAllowDraws",
    UPDATE_DOUBLE = "updateTournamentDoubleRounds",
    UPDATE_INCLUDE_SCORE = "updateTournamentIncludeScore",
