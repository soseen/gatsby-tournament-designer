        ...
        return (
            <div className='tournament-icons-wrapper'>
                ...
                {state.tournamentIcons.map((icon) => (
                    <button key={icon.id} className={state.tournamentDetails?.iconId === icon.id ? 'tournament-icon tournament-icon-selected' : 'tournament-icon'} onClick={() => updateIcon(icon.id)}>
